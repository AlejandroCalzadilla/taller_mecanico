  ...
  <AdminLayout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 min-h-screen"
      ...
      <div class="md:flex md:items-center md:justify-between mb-8">
        <div class="min-w-0 flex-1">
          <h2 class="text-2xl font-bold leading-7 sm:truncate sm:text-3xl sm:tracking-tight flex items-center gap-3"
            ...
            Editar Diagnóstico: <span class="font-mono ml-2" :style="{ color: 'var(--color-text-light)' }">{{ diagnostico.codigo }}</span>
          </h2>
      ...
      <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="border rounded-xl p-4 sm:p-6 flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between"
             :style="{ 
            ...
            <div class="flex items-start gap-4">
                <div class="p-3 rounded-full shadow-sm"
                     :style="{ backgroundColor: 'var(--color-base)' }">
                ...
                <div>
                    ...
                    <p class="text-sm font-mono" :style="{ color: 'var(--color-text-light)' }">{{ diagnostico.cita.vehiculo.placa }}</p>
                </div>
            </div>
        ...
        <form @submit.prevent="submit" class="shadow-sm sm:rounded-xl overflow-hidden"
              :style="{ 
                backgroundColor: 'var(--color-base)',
                borderColor: 'var(--color-border)',
                borderWidth: '1px'
            ...
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-base font-semibold leading-6 mb-6 flex items-center gap-2 pb-2"
                    :style="{ 
                      color: 'var(--color-text)',
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        <label for="mecanico_id" class="block text-sm font-medium leading-6" :style="{ color: 'var(--color-text)' }">Técnico Responsable</label>
                        <div class="relative mt-2">
                            ...
                            <select
                                ...
                                class="block w-full rounded-md py-2.5 pl-10 shadow-sm sm:text-sm sm:leading-6 focus:ring-2"
                                :style="{ 
                                  backgroundColor: 'var(--color-base)', 
                                  color: 'var(--color-text)', 
                        ...
                        <p v-if="form.errors.mecanico_id" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.mecanico_id }}</p>
                    </div>

                    <div class="sm:col-span-2">
                        <label for="fecha_diagnostico" class="block text-sm font-medium leading-6" :style="{ color: 'var(--color-text)' }">Fecha Actualización</label>
                        <div class="relative mt-2">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        ...
                        <p v-if="form.errors.fecha_diagnostico" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.fecha_diagnostico }}</p>
                    </div>

                    <div class="sm:col-span-2">
                        <label for="estado" class="block text-sm font-medium leading-6" :style="{ color: 'var(--color-text)' }">Estado Actual</label>
                        <div class="relative mt-2">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        ...
                        <p v-if="form.errors.estado" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.estado }}</p>
                    </div>

                    <div class="col-span-full">
                        <label for="descripcion_problema" class="block text-sm font-medium leading-6 flex items-center gap-2" :style="{ color: 'var(--color-text)' }">
                        ...
                        <div class="mt-2">
                            <textarea
                                ...
                                rows="3"
                                class="block w-full rounded-md py-1.5 shadow-sm sm:text-sm sm:leading-6 focus:ring-2"
                                :style="{ 
                                  backgroundColor: 'var(--color-base)', 
                                  color: 'var(--color-text)', 
                        ...
                        <p v-if="form.errors.descripcion_problema" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.descripcion_problema }}</p>
                    </div>

                    <div class="col-span-full">
                        <label for="diagnostico" class="block text-sm font-medium leading-6 flex items-center gap-2" :style="{ color: 'var(--color-text)' }">
                        ...
                        <p v-if="form.errors.diagnostico" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.diagnostico }}</p>
                    </div>

                    <div class="col-span-full">
                        <label for="recomendaciones" class="block text-sm font-medium leading-6 flex items-center gap-2" :style="{ color: 'var(--color-text)' }">
                        ...
                        <p v-if="form.errors.recomendaciones" class="mt-2 text-sm" :style="{ color: 'var(--color-error)' }">{{ form.errors.recomendaciones }}</p>
                    </div>

                </div>
            </div>

            <div class="px-4 py-4 sm:px-6 flex items-center justify-end gap-x-4"
                 :style="{ 
                   backgroundColor: 'var(--color-base)',
